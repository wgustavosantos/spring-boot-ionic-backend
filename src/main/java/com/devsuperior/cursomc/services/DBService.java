...
public class DBService {
	...
	public void instantiateTestDatabase() {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "gustavoinf18@gmail.com", "10069237484", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("12345678"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Gustavo Santos", "guto15santos@gmail.com", "64195478499", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("12345678"));
		...
		Pedido ped2 = new Pedido(null, LocalDateTime.of(2022, 02, 10, 19, 35), e2, cli2);
